...
const PaintEditing = ({ location }) => {
  const { myPaint, paintId } = location.state;
  const history = useHistory();

  const [newPaint, setNewPaint] = useState(myPaint.name);
  const [newArtist, setNewArtist] = useState(myPaint.artist);
  const [newPrice, setNewPrice] = useState(myPaint.price);
  const [newDescription, setNewDescription] = useState(myPaint.description);
  const [newYear, setNewYear] = useState(myPaint.year);
    ...
    <UploadContainer>
      <UploadFormWrap themeProps={theme}>
        ...
        <UploadForm onSubmit={onSubmit}>
          ...
          <FileUploadContainer>
            <img src={myPaint.attachmentUrl} alt="attachment" />
          </FileUploadContainer>
